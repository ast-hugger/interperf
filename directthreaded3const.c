/*
    Derived from directthreaded3.c:

        Introducing a series of CONST* instructions in addition to LIT n,
        for pushing onto the stack common constants without involving the literal table.

    Observations (Clang):

        - 4% performance improvement compared to directthreaded3
        - 3.1x performance improvment compared to wordcode2
